...
import { PlusCircle, ShoppingCart,Minus, Plus } from "lucide-react"
...
<div className="flex items-center justify-between mt-2">
  <span className="text-xs font-medium text-gray-600 bg-gray-100 px-2 py-2 rounded-full">{item.unit}</span>
...
className="mt-4 flex items-center justify-center bg-purple-50 border border-purple-200 rounded-full py-2 px-4 gap-4"
>
