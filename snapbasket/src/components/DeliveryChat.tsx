...
useEffect(()=>{
    ...
    const handleMessage = (message:IMessage) => {
      ...
      setMessages(prev => prev.some(item => item._id?.toString() === message._id?.toString()) ? prev : [...prev, message])
    }
...
const getSuggestion=async ()=>{
  ...
  return (
    <div className='bg-white rounded-3xl shadow-lg border p-4 h-107.5 flex flex-col mt-6'>
